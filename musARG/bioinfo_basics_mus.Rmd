...
# Usage: sbatch code/singer_arg.sh wmgp.deepVar.jointGenotyping.20250929.chr19.filtered.vep.filtered.phased.vcf.gz
...
# singer_master -vcf $SCRATCH_DIR/$vcf_prefix \
# -m $U_RATE \
...
parallel_singer -vcf $SCRATCH_DIR/$vcf_prefix \
-m $U_RATE -Ne 500000 \
-n 10 -thin 50 \
-output $OUT_DIR/$vcf_prefix\_singer \
